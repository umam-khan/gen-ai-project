        ...
        <div className='flex flex-col justify-betwwen h-full overflow-y-scroll pb-96'>
            ...
            <div className='mt-5 px-5'>
                {messages.map((audio,index)=> {
                    return <div key={index} className={"flex flex-col "+ (audio.sender == "john" && "flex items-end")}>
                        {/* sender */}
                        <div className='mt-4'>
                            <p className={audio.sender == "john" ? "text-right mr-2 italic text-green-500" : "ml-2 italic text-blue-500"} >
                                {audio.sender}
                            </p>
                            {/* audio message here */}
