      ...
      <footer className="px-5 sm:px-10 md:px-20 py-8">
        <div className="flex flex-col items-center lg:flex-row-reverse justify-between">
          <div>
            ...
            <Link className="mx-4 text-sm font-bold text-indigo-600 hover:text-indigo-800" to="/about">About Us</Link>
            <Link className="mx-4 text-sm font-bold text-indigo-600 hover:text-indigo-800" to="/careers">Careers</Link>
          </div>
          <div className="mt-4">
